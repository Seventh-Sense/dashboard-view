<template>
  ...
  >
    ...
    <n-space v-if="reverseList.length === 0" justify="center">
      <n-text class="not-layer-text">{{ $t('dashboard.layer_no_text') }}</n-text>
    </n-space>
...
const layerModeList = [
  {
    ...
    icon: LaptopIcon,
    value: LayerModeEnum.THUMBNAIL
  },
  { label: t('dashboard.text_list'), icon: ListIcon, value: LayerModeEnum.TEXT }
]
