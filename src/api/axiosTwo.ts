...
axiosTwo.interceptors.request.use(
  (config: InternalAxiosRequestConfig) => {
    ...
    //const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTc3Njk1MTc1MCwidHlwZSI6ImFjY2VzcyJ9.RdeNheZxQMpwB5NVUoXbGn13-cITjNtXnhuneYfSgog'
    if (token) {
