...
export enum GraphicEnum {
  // 图表创建
  CHART_GRAPHIC = '/graphic/:id(.*)*',
  CHART_GRAPHIC_NAME = 'Graphic'
}

export enum GraphicPreviewEnum {
  //  图表预览
  CHART_GRAPHIC_PREVIEW = '/graphic/preview/:id(.*)*',
  CHART_GRAPHIC_PREVIEW_NAME = 'GraphicPreview'
}
